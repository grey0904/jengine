	...
	},
	{
		...
		Flags: []cli.Flag{
			cli.StringFlag{
				...
				Value: "github.com/grey0904/jengine-layout",
			},
			cli.StringFlag{
				Name:  "branch",
	...
	},
	{
		...
		Flags: []cli.Flag{
			cli.StringFlag{
				...
				Value: "github.com/grey0904/jengine/cmd/jupiter",
			},
		},
	},
	{
...
func TestCMD(t *testing.T) {
	...
	run([]string{"jupiter", "new", "/tmp/test-go", "-remote", "github.com/grey0904/jengine-layout", "-branch", "main"})
